...
const faculty_ece = [
  { name: "Dr. Rajesh K.", role: "Professor & HOD", specialization: "VLSI Design" },
  { name: "Mrs. Meena S.", role: "Associate Professor", specialization: "Embedded Systems" },
  { name: "Mr. Abhilash P.", role: "Assistant Professor", specialization: "Wireless Communication" },
];
    ...
    <main className="pt-[112px]">
      <section className="bg-[#071429] py-24 px-6 relative overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <img src="https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&q=80&w=1920" alt="ECE" className="w-full h-full object-cover" />
        </div>
        <div className="max-w-7xl mx-auto relative z-10">
          <span className="text-blue-500 font-black text-xs uppercase tracking-[0.4em] mb-4 block">Future of Connectivity</span>
          <h1 className="text-5xl md:text-7xl font-black text-white leading-tight tracking-tighter mb-8 italic">
            Electronics &<br />Communication Engineering
          </h1>
          <div className="flex gap-2 text-[10px] font-bold uppercase tracking-widest text-white/40">
            ...
            <span>/</span>
            <span className="text-white/80">ECE</span>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-24">
            <div>
              ...
              <p className="text-gray-600 font-medium leading-relaxed mb-8 text-lg">
                The ECE department is at the heart of the digital revolution. From silicon chips to global communication networks, we empower students to design the hardware and protocols that connect the world.
              </p>
              <div className="grid grid-cols-2 gap-6">
                 <div className="p-6 rounded-2xl bg-[#f6f9ff] border border-blue-50">
                   <div className="text-3xl font-black text-blue-500 mb-1">15+</div>
                   <div className="text-[10px] font-black uppercase tracking-widest text-gray-400">Speculalized Labs</div>
                 </div>
                 <div className="p-6 rounded-2xl bg-[#f6f9ff] border border-blue-50">
                   <div className="text-3xl font-black text-blue-500 mb-1">20+</div>
                   <div className="text-[10px] font-black uppercase tracking-widest text-gray-400">Patents Filed</div>
                 </div>
              </div>
            </div>
            <div className="rounded-[4rem] overflow-hidden shadow-2xl">
              <img src="https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&q=80&w=800" className="w-full h-full object-cover" />
            </div>
          </div>
