...
const faculty_ise = [
  { name: "Dr. Sanjay J.", role: "Professor & HOD", specialization: "Data Science" },
  { name: "Ms. Kavitha M.", role: "Associate Professor", specialization: "Big Data" },
  { name: "Mr. Raghavendra", role: "Assistant Professor", specialization: "Web Technologies" },
];

export default function ISEDepartmentPage() {
  return (
    <main className="pt-[112px]">
      <section className="bg-[#071429] py-24 px-6 relative overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <img src="https://images.unsplash.com/photo-1550751827-4bd374c3f58b?auto=format&fit=crop&q=80&w=1920" alt="ISE" className="w-full h-full object-cover" />
        </div>
        <div className="max-w-7xl mx-auto relative z-10">
          <span className="text-blue-500 font-black text-xs uppercase tracking-[0.4em] mb-4 block">Data Driven Innovation</span>
          ...
          <div className="flex gap-2 text-[10px] font-bold uppercase tracking-widest text-white/40">
            ...
            <span>/</span>
            <span className="text-white/80">ISE</span>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-24">
            <div>
              ...
              <p className="text-gray-600 font-medium leading-relaxed mb-8 text-lg">
                The ISE department focuses on the management and analysis of information. We prepare students for the rapidly evolving world of data science, cloud computing, and intelligent systems.
              </p>
              <div className="grid grid-cols-2 gap-6">
                 <div className="p-6 rounded-2xl bg-[#f6f9ff] border border-blue-50">
                   ...
                   <div className="text-[10px] font-black uppercase tracking-widest text-gray-400">Project Labs</div>
                 </div>
                 <div className="p-6 rounded-2xl bg-[#f6f9ff] border border-blue-50">
                   <div className="text-3xl font-black text-blue-500 mb-1">98%</div>
                   <div className="text-[10px] font-black uppercase tracking-widest text-gray-400">Internship Success</div>
                 </div>
              </div>
            </div>
            <div className="rounded-[4rem] overflow-hidden shadow-2xl">
              <img src="https://images.unsplash.com/photo-1550751827-4bd374c3f58b?auto=format&fit=crop&q=80&w=800" className="w-full h-full object-cover" />
            </div>
          </div>
