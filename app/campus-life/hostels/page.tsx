...
const features = [
  { name: "Accommodation", icon: "🏠", desc: "Separate hostels for boys and girls with spacious rooms." },
  { name: "Dining", icon: "🍱", desc: "Nutritious and hygienic veg/non-veg food options." },
  { name: "Security", icon: "🛡️", desc: "24/7 security with CCTV surveillance and wardens." },
  { name: "Connectivity", icon: "🌐", desc: "High-speed Wi-Fi across the entire hostel blocks." },
  { name: "Common Area", icon: "📺", desc: "Recreation rooms with TV, Indoor games and lounge." },
  { name: "Laundry", icon: "🧺", desc: "In-house laundry and solar water heating systems." },
];
    ...
    <main className="pt-[112px]">
      <section className="bg-[#071429] py-24 px-6 relative overflow-hidden text-center">
        <div className="absolute inset-0 opacity-20">
          <img src="https://images.unsplash.com/photo-1555854817-ac296536340c?auto=format&fit=crop&q=80&w=1920" alt="Hostels" className="w-full h-full object-cover" />
        </div>
        <div className="max-w-7xl mx-auto relative z-10">
          <span className="text-blue-500 font-black text-xs uppercase tracking-[0.4em] mb-4 block">Home Away From Home</span>
          ...
          <div className="flex justify-center gap-2 text-[10px] font-bold uppercase tracking-widest text-white/40">
            ...
            <span>/</span>
            <span className="text-white/80">Hostels</span>
          </div>
        </div>
      </section>
